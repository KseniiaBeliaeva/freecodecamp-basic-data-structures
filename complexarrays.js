...
/* We have defined a variable, myNestedArray, set equal to an array.Modify myNestedArray, using any combination
of strings, numbers, and booleans for data elements, so that it has exactly five levels of depth(remember,
...
let myNestedArray = [
    ...
    [ //2 
        ...
        [
            ['loop', 'shift', 6, 7, 1000, 'method', 'deeper', ['deepest']] //4,5
        ]
    ], //2
    [
